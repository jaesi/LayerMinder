...
def combine_with_style(user_image_path, style_image_set_folder, output_folder): # user_image_path: 사용자 이미지 경로, style_image_set_folder: 스타일 세트 폴더 경로, output_folder: 출력 폴더 경로
    try:
        ...
        # style images list에서 random으로 선택
